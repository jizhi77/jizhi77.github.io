...
```
详细的资料可以参考：<br />[《CSS 盒模型详解》](https://link.zhihu.com/?target=https%3A//juejin.im/post/59ef72f5f265da4320026f76)
<a name="h4zLM"></a>
## 2.CSS 选择符有哪些？
```
（1）id选择器（#myid）
...
```
详细资料可以参考：<br />[《总结伪类与伪元素》](https://link.zhihu.com/?target=http%3A//www.alloyteam.com/2016/05/summary-of-pseudo-classes-and-pseudo-elements/)
<a name="WaLJA"></a>
## 5.CSS 中哪些属性可以继承？
相关资料：
```
...
```
详细的资料可以参考：<br />[《继承属性》](https://link.zhihu.com/?target=https%3A//developer.mozilla.org/zh-CN/docs/Web/CSS/inheritance)<br />[《CSS 有哪些属性可以继承？》](https://link.zhihu.com/?target=https%3A//www.jianshu.com/p/34044e3c9317)
<a name="9lIrR"></a>
## 6.CSS 优先级算法如何计算？
相关知识点：
```
...
入的顺序，后出现的规则的优先级最高。
```
对于组合声明的特殊性值计算可以参考：<br />[《CSS 优先级计算及应用》](https://link.zhihu.com/?target=https%3A//www.jianshu.com/p/1c4e639ff7d5)<br />[《CSS 优先级计算规则》](https://link.zhihu.com/?target=http%3A//www.cnblogs.com/wangmeijian/p/4207433.html)
<a name="7T452"></a>
## 7.关于伪类 LVHA 的解释?
```
...
```
详细的资料可以参考：<br />[《CSS3 新特性总结(伪类)》](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/SKLthegoodman/p/css3.html)<br />[《浅谈 CSS 伪类和伪元素及 CSS3 新增伪类》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/zhouziyu2011/article/details/58605705)
<a name="o66zb"></a>
## 9.如何居中 div？
...
```
详细资料可以参考：<br />[《CSSdisplay 属性》](https://link.zhihu.com/?target=http%3A//www.w3school.com.cn/css/pr_class_display.asp)
<a name="a0SxU"></a>
...
```
详细资料可以参考：<br />[《Flex 布局教程：语法篇》](https://link.zhihu.com/?target=http%3A//www.ruanyifeng.com/blog/2015/07/flex-grammar.html)<br />[《Flex 布局教程：实例篇》](https://link.zhihu.com/?target=http%3A//www.ruanyifeng.com/blog/2015/07/flex-examples.html)
<a name="sdzlD"></a>
...
的特性，来实现多列等高。
```
详细资料可以参考：<br />[《前端应该掌握的 CSS 实现多列等高布局》](https://link.zhihu.com/?target=https%3A//juejin.im/post/5b0fb34151882515662238fd)<br />[《CSS：多列等高布局》](https://link.zhihu.com/?target=https%3A//codepen.io/yangbo5207/post/equh)
<a name="hJC3D"></a>
...
```
<a name="Ss5lc"></a>
## [http://18.li](https://link.zhihu.com/?target=http%3A//18.li) 与 li 之间有看不见的空白间隔是什么原因引起的？有什么解决办法？
```
...
```
详细资料可以参考：<br />[《li 与 li 之间有看不见的空白间隔是什么原因引起的？》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/sjinsa/article/details/70919546)
<a name="WBRGA"></a>
## 19.为什么要初始化 CSS 样式？
```
...
置。
```
详细资料可以参考：<br />[《CSS 里的 visibility 属性有个鲜为人知的属性值：collapse》](https://link.zhihu.com/?target=http%3A//www.webhek.com/post/visibility-collapse.html)
<a name="g48s5"></a>
...
```
详细资料可以参考：<br />[《玩转图片 base64 编码》](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/coco1s/p/4375774.html)<br />[《前端开发中，使用 base64 图片的弊端是什么？》](https://www.zhihu.com/question/31155574)<br />[《小 tip:base64:URL 背景图片与 web 页面性能优化》](https://link.zhihu.com/?target=https%3A//www.zhangxinxu.com/wordpress/2012/04/base64-url-image-%25E5%259B%25BE%25E7%2589%2587-%25E9%25A1%25B5%25E9%259D%25A2%25E6%2580%25A7%25E8%2583%25BD%25E4%25BC%2598%25E5%258C%2596/)
<a name="2kVnR"></a>
...
```
详细资料可以参考：<br />[《position 跟 display、margincollapse、overflow、float 这些特性相互叠加后会怎么样？》](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/jackyWHJ/p/3756087.html)
<a name="2xgcK"></a>
## 26.margin 重叠问题的理解。
相关知识点：
```
...
```
详细资料可以参考：<br />[《深入理解 BFC 和 MarginCollapse》](https://link.zhihu.com/?target=https%3A//www.w3cplus.com/css/understanding-bfc-and-margin-collapse.html)<br />[《前端面试题-BFC（块格式化上下文）》](https://link.zhihu.com/?target=https%3A//segmentfault.com/a/1190000013647777)
<a name="uLCVA"></a>
## 28.IFC 是什么？
```
...
```
详细资料可以参考：<br />[《BFC 和 IFC 的理解（布局）》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/paintandraw/article/details/80401741)
<a name="drO1J"></a>
...
```
详细资料可以参考：<br />[《CSS3@media 查询》](https://link.zhihu.com/?target=http%3A//www.runoob.com/cssref/css3-pr-mediaquery.html)<br />[《响应式布局和自适应布局详解》](https://link.zhihu.com/?target=http%3A//caibaojian.com/356.html)
<a name="wni1d"></a>
...
```
详细资料可以参考：<br />[《CSS 优化、提高性能的方法有哪些？》](https://www.zhihu.com/question/19886806)<br />[《CSS 优化，提高性能的方法》](https://link.zhihu.com/?target=https%3A//www.jianshu.com/p/4e673bf24a3b)
<a name="pkFRB"></a>
...
```
详细资料可以参考：<br />[《探究 CSS 解析原理》](https://link.zhihu.com/?target=https%3A//juejin.im/entry/5a123c55f265da432240cc90)
<a name="UFrEb"></a>
...
```
详细资料可以参考：<br />[《谈谈网页中使用奇数字体和偶数字体》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/jian_xi/article/details/79346477)<br />[《现在网页设计中的为什么少有人用 11px、13px、15px 等奇数的字体？》](https://www.zhihu.com/question/20440679)
<a name="y6GMA"></a>
...
进业务相关的库里面做成对应功能的模块儿。
```
详细资料可以参考：<br />[《CSS 规范-分类方法》](https://link.zhihu.com/?target=http%3A//nec.netease.com/standard/css-sort.html)
<a name="6PEqc"></a>
...
```
详细资料可以参考：<br />[《简单了解 CSS3 的 all 属性》](https://link.zhihu.com/?target=https%3A//www.zhangxinxu.com/wordpress/2016/03/know-about-css3-all/)
<a name="q0OQB"></a>
...
成这些工作。
```
详细资料可以参考：<br />[《CSS 基础篇--CSS 中 IE 浏览器的 hasLayout，IE 低版本的 bug 根源》](https://link.zhihu.com/?target=https%3A//segmentfault.com/a/1190000010883974)<br />[《CSS 魔法堂：hasLayout 原来是这样的！》](https://link.zhihu.com/?target=https%3A//segmentfault.com/a/1190000004632071)
<a name="Z1TdK"></a>
...
```
详细资料可以参考：<br />[《js 实现网页全屏切换（平滑过渡），鼠标滚动切换》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/liona_koukou/article/details/52680409)<br />[《用 ES6 写全屏滚动插件》](https://link.zhihu.com/?target=https%3A//juejin.im/post/5aeef41cf265da0ba0630de0)
<a name="jtTFy"></a>
...
```
详细资料可以参考：<br />[《响应式布局原理》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/dreamerframework/article/details/8994741)<br />[《响应式布局的实现方法和原理》](https://link.zhihu.com/?target=http%3A//www.mahaixiang.cn/wzsj/278.html)
<a name="3gFxD"></a>
## 46.视差滚动效果，如何给每页做不同的动画？（回到顶部，向下滑动要再次出现，和只出现一次分别怎么做？）
```
视差滚动是指多层背景以不同的速度移动，形成立体的运动效果，带来非常出色的视觉体验。
```
详细资料可以参考：<br />[《如何实现视差滚动效果的网页？》](https://www.zhihu.com/question/20990029)
<a name="sjwct"></a>
...
```
详细资料可以参考：<br />[《去掉 chrome 记住密码后的默认填充样式》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/zsl_955200/article/details/78276209)<br />[《修改谷歌浏览器 chrome 记住密码后自动填充表单的黄色背景》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/M_agician/article/details/73381706)
<a name="0QwuV"></a>
...
```
详细资料可以参考：<br />[《谷歌浏览器不支持 CSS 设置小于 12px 的文字怎么办？》](https://link.zhihu.com/?target=https%3A//570109268.iteye.com/blog/2406562)
<a name="FLUT1"></a>
...
置后无效。
```
详细资料可以参考：<br />[《让字体变的更清晰 CSS 中-webkit-font-smoothing》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/huo_bao/article/details/50251585)
<a name="0Z3qJ"></a>
...
```
详细资料可以参考：<br />[《什么是物理像素、虚拟像素、逻辑像素、设备像素，什么又是 PPI,DPI,DPR 和 DIP》](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/libin-1/p/7148377.html)<br />[《前端工程师需要明白的「像素」》](https://link.zhihu.com/?target=https%3A//www.jianshu.com/p/af6dad66e49a)<br />[《CSS 像素、物理像素、逻辑像素、设备像素比、PPI、Viewport》](https://link.zhihu.com/?target=https%3A//github.com/jawil/blog/issues/21)<br />[《前端开发中像素的概念》](https://link.zhihu.com/?target=https%3A//github.com/wujunchuan/wujunchuan.github.io/issues/15)
<a name="xcvuF"></a>
...
```
详细资料可以参考：<br />[《移动前端开发之 viewport 的深入理解》](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/2050/p/3877280.html)<br />[《说说移动前端中 viewport（视口）》](https://link.zhihu.com/?target=https%3A//www.html.cn/archives/5975)<br />[《移动端适配知识你到底知多少》](https://link.zhihu.com/?target=https%3A//juejin.im/post/5b6d21daf265da0f9d1a2ed7%23heading-14)
<a name="jc3Hq"></a>
...
```
详细资料可以参考：<br />[《去除 inline-block 元素间间距的 N 种方法》](https://link.zhihu.com/?target=https%3A//www.zhangxinxu.com/wordpress/2012/04/inline-block-space-remove-%25E5%258E%25BB%25E9%2599%25A4%25E9%2597%25B4%25E8%25B7%259D/)
<a name="SgCLQ"></a>
...
畅。
```
详细资料可以参考：<br />[《解决页面使用 overflow:scroll 在 iOS 上滑动卡顿的问题》](https://link.zhihu.com/?target=https%3A//www.jianshu.com/p/1f4693d0ad2d)
<a name="9pgLc"></a>
...
```
详细资料可以参考：<br />[《有一个高度自适应的 div，里面有两个 div，一个高度 100px，希望另一个填满剩下的高度(三种方案)》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/xutongbao/article/details/79408522)
<a name="9TpAX"></a>
...
```
详细资料可以参考：<br />[《图片格式那么多，哪种更适合你？》](https://link.zhihu.com/?target=https%3A//www.cnblogs.com/xinzhao/p/5130410.html)
<a name="OHnwW"></a>
...
```
详细资料可以参考：<br />[《判断浏览器是否支持 WebP 图片》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/jesslu/article/details/82495061)<br />[《toDataURL()》](https://link.zhihu.com/?target=https%3A//developer.mozilla.org/zh-CN/docs/Web/API/HTMLCanvasElement/toDataURL)
<a name="fWxbj"></a>
...
http请求的解析速度。
```
详细资料可以参考：<br />[《CDN 是什么？使用 CDN 有什么优势？》](https://www.zhihu.com/question/36514327?rf=37353035)
<a name="XzsJG"></a>
...
览器私有前缀，实现跨浏览器兼容性的问题。
```
详细资料可以参考：<br />[《CSS 预处理器和后处理器》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/yushuangyushuang/article/details/79209752)
<a name="6eIqs"></a>
## 63.阐述一下 CSSSprites
```
...
题。
```
详细资料可以参考：<br />[《css3 的字体大小单位 rem 到底好在哪？》](https://www.zhihu.com/question/21504656)<br />[《VW:是时候放弃 REM 布局了》](https://link.zhihu.com/?target=https%3A//www.jianshu.com/p/e8ae1c3861dc)<br />[《为什么设计稿是 750px》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/Honeymao/article/details/76795089)<br />[《使用 Flexible 实现手淘 H5 页面的终端适配》](https://link.zhihu.com/?target=https%3A//github.com/amfe/article/issues/17)
<a name="cfOaz"></a>
## 65.几种常见的 CSS 布局
详细的资料可以参考：<br />[《几种常见的 CSS 布局》](https://link.zhihu.com/?target=https%3A//juejin.im/post/5bbcd7ff5188255c80668028%23heading-12)
<a name="PJjoI"></a>
## 66.画一条 0.5px 的线
```
采用metaviewport的方式
...
```
详细资料可以参考：<br />[《怎么画一条 0.5px 的边（更新）》](https://link.zhihu.com/?target=https%3A//juejin.im/post/5ab65f40f265da2384408a95)
<a name="QS5jk"></a>
...
```
详细资料可以参考：<br />[《CSSanimation 与 CSStransition 有何区别？》](https://www.zhihu.com/question/19749045)<br />[《CSS3Transition 和 Animation 区别及比较》](https://link.zhihu.com/?target=https%3A//blog.csdn.net/cddcj/article/details/53582334)<br />[《CSS 动画简介》](https://link.zhihu.com/?target=http%3A//www.ruanyifeng.com/blog/2014/02/css_transition_and_animation.html)<br />[《CSS 动画：animation、transition、transform、translate》](https://link.zhihu.com/?target=https%3A//juejin.im/post/5b137e6e51882513ac201dfb)
<a name="Wqsb2"></a>
## 68.什么是首选最小宽度？
```
...
<a name="rxcA0"></a>
## 89.元素的层叠顺序？
层叠顺序，英文称作 stackingorder，表示元素发生层叠时有着特定的垂直显示顺序。<br />
<br />![](https://pic3.zhimg.com/80/v2-06c60210df13e7677a031a3ff01beb9a_1440w.jpg#align=left&display=inline&message=%E4%B8%8A%E4%BC%A0%E5%9B%BE%E7%89%87%E5%A4%B1%E8%B4%A5%EF%BC%8C%E8%AF%B7%E9%87%8D%E8%AF%95&percent=0&status=uploading&width=528)<br />
...
发时加载。
```
回答：<br />-（1）元素的背景图片<br />-元素本身设置 display:none，会请求图片 -父级元素设置 display:none，不会请求图片 -样式没有元素使用，不会请求<br />-:hover 样式下，触发时请求<br />-（2）img 标签图片任何情况下都会请求图片<br />详细资料可以参考：<br />[《CSS 控制前端图片 HTTP 请求的各种情况示例》](https://link.zhihu.com/?target=https%3A//www.jb51.net/css/469033.html)
<a name="zTGnS"></a>
## 97.如何实现单行／多行文本溢出的省略（...）？
```
/*单行文本溢出*/
...
```
详细资料可以参考：<br />[《【CSS/JS】如何实现单行／多行文本溢出的省略》](https://zhuanlan.zhihu.com/p/30707916)<br />[《CSS 多行文本溢出省略显示》](https://link.zhihu.com/?target=https%3A//juejin.im/entry/587f453e1b69e60058555a5f)
<a name="pHTUO"></a>
## 98.常见的元素隐藏方式？
-（1）使用 display:none;隐藏元素，渲染树不会包含该渲染对象，因此该元素不会在页面中占据位置，也不会响应绑定的监听事件。<br />-（2）使用 visibility:hidden;隐藏元素。元素在页面中仍占据空间，但是不会响应绑定的监听事件。<br />-（3）使用 opacity:0;将元素的透明度设置为 0，以此来实现元素的隐藏。元素在页面中仍然占据空间，并且能够响应元素绑定的监听事件。<br />-（4）通过使用绝对定位将元素移除可视区域内，以此来实现元素的隐藏。<br />-（5）通过 z-index 负值，来使其他元素遮盖住该元素，以此来实现隐藏。<br />-（6）通过 clip/clip-path 元素裁剪的方法来实现元素的隐藏，这种方法下，元素仍在页面中占据位置，但是不会响应绑定的监听事件。<br />-（7）通过 transform:scale(0,0)来将元素缩放为 0，以此来实现元素的隐藏。这种方法下，元素仍在页面中占据位置，但是不会响应绑定的监听事件。<br />详细资料可以参考：<br />[《CSS 隐藏元素的八种方法》](https://link.zhihu.com/?target=https%3A//juejin.im/post/584b645a128fe10058a0d625%23heading-2)
<a name="f7zHV"></a>
...
```
详细资料可以参考：<br />[《css 实现上下固定中间自适应布局》](https://link.zhihu.com/?target=https%3A//www.jianshu.com/p/30bc9751e3e8)
<a name="i8rYX"></a>
## 100.css 两栏布局的实现？
相关资料：
```
...
```
[《两栏布局 demo 展示》](https://link.zhihu.com/?target=http%3A//cavszhouyou.top/Demo-Display/TwoColumnLayout/index.html)<br />回答：<br />两栏布局一般指的是页面中一共两栏，左边固定，右边自适应的布局，一共有四种实现的方式。<br />以左边宽度固定为 200px 为例<br />-（1）利用浮动，将左边元素宽度设置为 200px，并且设置向左浮动。将右边元素的 margin-left 设置为 200px，宽度设置为 auto（默认为 auto，撑满整个父元素）。<br />-（2）第二种是利用 flex 布局，将左边元素的放大和缩小比例设置为 0，基础大小设置为 200px。将右边的元素的放大比例设置为 1，缩小比例设置为 1，基础大小设置为 auto。<br />-（3）第三种是利用绝对定位布局的方式，将父级元素设置相对定位。左边元素设置为 absolute 定位，并且宽度设置为 200px。将右边元素的 margin-left 的值设置为 200px。<br />-（4）第四种还是利用绝对定位的方式，将父级元素设置为相对定位。左边元素宽度设置为 200px，右边元素设置为绝对定位，左边定位为 200px，其余方向定位为 0。
<a name="n3zsV"></a>
## 101.css 三栏布局的实现？
相关资料：
```
...
```
[《三栏布局 demo 展示》](https://link.zhihu.com/?target=http%3A//cavszhouyou.top/Demo-Display/ThreeColumnLayout/index.html)<br />回答：
```
三栏布局一般指的是页面中一共有三栏，左右两栏宽度固定，中间自适应的布局，一共有五种实现方式。
这里以左边宽度固定为100px，右边宽度固定为200px为例。
（1）利用绝对定位的方式，左右两栏设置为绝对定位，中间设置对应方向大小的margin的值。
...
```
[《自适应正方形 demo 展示》](https://link.zhihu.com/?target=http%3A//cavszhouyou.top/Demo-Display/AdaptiveSquare/index.html)
<a name="mUccf"></a>
## 103.实现一个三角形
```
...
```
[《三角形 demo 展示》](https://link.zhihu.com/?target=http%3A//cavszhouyou.top/Demo-Display/Triangle/index.html)
<a name="0cFSF"></a>
...
<a name="pTE6E"></a>
## 推荐
笔者再次墙裂推荐收藏这篇原文，转载于 [CavsZhouyou - 前端面试复习笔记](https://link.zhihu.com/?target=https%3A//github.com/CavsZhouyou/Front-End-Interview-Notebook/blob/master/Css/Css.md)，这个仓库是原作者校招时的前端复习笔记，主要总结一些比较重要的知识点和前端面试问题，希望对大家有所帮助。<br />最后如果文章和笔记能带您一丝帮助或者启发，请不要吝啬你的赞和收藏，你的肯定是我前进的最大动力
